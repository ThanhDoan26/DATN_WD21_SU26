...
class DashboardService
{
    ...
    ): array
    {
        ...
        // 1. Tổng số người dùng (đang hoạt động) thuộc rạp
        ...
        // 4. Tá»•ng sá»‘ suáº¥t chiáº¿u (chÆ°a bá»‹ xÃ³a má» m)
        ...
        // 5. Tá»•ng sá»‘ vÃ© Ä‘Ã£ bÃ¡n (thuá»™c cÃ¡c booking Ä‘Ã£ thanh toÃ¡n hoáº·c Ä‘Ã£ sá»­ dá»¥ng)
        ...
        // 9. Dá»¯ liá»‡u biá»ƒu Ä‘á»“ (Chart Data)
