...
<head>
    ...
    <title>@yield('title', 'Cinema Manager Dashboard') - Cinema Booking System</title>
    
    <script>
        (function() {
            const savedTheme = localStorage.getItem('manager_theme') || 'light';
            if (savedTheme === 'dark') {
...
<body>
    ...
    <aside class="sidebar">
        <div class="sidebar-header">
            <h4><i class="fas fa-video"></i> MovieGo</h4>
            <p>Manager Panel</p>
        </div>
    ...
    <div class="main-content">
        ...
        <div class="topbar">
            <div class="d-flex align-items-center gap-3">
                <h5 class="mb-0">@yield('page_title', 'Cinema Manager')</h5>
                @if(Auth::user()->cinema && !empty(Auth::user()->cinema->name))
                    <span class="badge bg-success-subtle text-success border border-success-subtle px-3 py-1 rounded-pill fw-bold small font-sora">
            ...
            <div class="topbar-right d-flex align-items-center">
                ...
                <button type="button" class="theme-toggle-btn me-3" id="themeToggleBtn" onclick="toggleManagerTheme()" title="Chuyển đổi Chế độ Sáng / Tối">
                ...
                <div class="dropdown">
                    <div class="d-flex align-items-center gap-2 dropdown-toggle" id="userDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false" style="cursor: pointer;">
                        <div class="text-end">
                            ...
                            <strong class="font-sora text-ink fs-6">{{ Auth::user()->name ?? 'Manager' }}</strong>
                        </div>
                    ...
                    <ul class="dropdown-menu dropdown-menu-end shadow-lg border-0 rounded-4 mt-2" aria-labelledby="userDropdown">
                        <li>
                            <a href="{{ route('profile.edit') }}" class="dropdown-item py-2 fw-semibold">
                                <i class="fas fa-user-circle me-2 text-success"></i> Hồ sơ cá nhân
                            </a>
                        </li>
