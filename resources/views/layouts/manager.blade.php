...
<head>
    ...
    <title>@yield('title', 'Cinema Manager Dashboard')</title>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .sidebar-header h4 { margin: 0; font-size: 1.3rem; font-weight: 700; }
...
<body>
    <aside class="sidebar">
        <div class="sidebar-header">
            <h4><i class="fas fa-video"></i> Cinema</h4>
            <p>Manager Panel</p>
        </div>
                ...
                <div class="dropdown">
                    <div class="user-info dropdown-toggle" id="userDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false" style="cursor: pointer;">
                        <div class="text-end">
                            ...
                            <strong style="color: #333;">{{ Auth::user()->name ?? 'Manager' }}</strong>
                        </div>
