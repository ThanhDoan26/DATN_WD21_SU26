...
<head>
    ...
    <style>
        ...
        :root {
            ...
            --sidebar-bg: #1c1408;
            --sidebar-text: #fde68a;
            --sidebar-hover-bg: rgba(245, 158, 11, 0.1);
            --sidebar-hover-text: #ffffff;
            --sidebar-active-bg: linear-gradient(135deg, #d97706 0%, #f59e0b 100%);
        ...
        * {
        ...
        .sidebar-header .staff-tag-wrapper {
            display: flex;
            align-items: center;
            gap: 8px;
            margin-top: 4px;
...
=======
=======
>>>>>>> 252d9294d26bf55971acc18a6c5f5f6883adf214
    <!-- Chart.js CDN -->
