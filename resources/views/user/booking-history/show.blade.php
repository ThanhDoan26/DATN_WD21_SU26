...
<div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
    ...
    <div class="relative group">
        ...
        <div class="bg-slate-800 rounded-3xl overflow-hidden shadow-[0_20px_50px_rgba(0,0,0,0.5)] border border-slate-700/50">
            ...
            <!-- Footer Note -->
            <div class="bg-slate-900/50 p-6 border-t border-slate-700/50 text-center">
                <p class="text-slate-500 text-xs">
                    <i class="fas fa-info-circle mr-2"></i>Vé đã mua không thể hoàn trả hoặc đổi trả theo quy chuẩn nghiệp vụ của rạp movieGo.
                </p>
            </div>
        </div>
    </div>
