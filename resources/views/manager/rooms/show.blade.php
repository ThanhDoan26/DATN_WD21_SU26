...
<div class="page-title d-flex justify-content-between align-items-center">
    ...
    <div>
        <a href="{{ route('manager.rooms.edit', $room->id) }}" class="btn btn-warning">
        ...
        <div class="card mt-3">
            ...
            <div class="card-body">
                ...
                @else
                    ...
                    <form action="{{ route('manager.rooms.destroy', $room->id) }}" method="POST" onsubmit="return confirm('Bạn có chắc chắn muốn xóa phòng chiếu này?');">
                        @csrf
                        @method('DELETE')
