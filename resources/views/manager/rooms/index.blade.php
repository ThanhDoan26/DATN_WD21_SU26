...
<div class="page-title d-flex justify-content-between align-items-center">
    ...
    <div class="d-flex gap-2">
        <a href="{{ route('manager.rooms.trashed') }}" class="btn btn-secondary" title="Xem phòng đã xóa">
        ...
        <form action="{{ route('manager.rooms.index') }}" method="GET" class="row align-items-center g-3">
            ...
            <div class="col-12 col-md-auto d-flex gap-2">
                ...
                @if((request()->has('search') && request('search') != '') || (request()->has('status') && request('status') != ''))
                    <a href="{{ route('manager.rooms.index') }}" class="btn btn-outline-secondary">Xóa bộ lọc</a>
                @endif
            </div>
        </form>
    </div>
        ...
        <table class="table table-hover">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <div class="d-flex gap-2">
                            <a href="{{ route('manager.rooms.show', $room->id) }}" class="btn btn-sm btn-info text-white" title="Chi tiết">
                                <i class="fas fa-eye"></i>
                            </a>
                            <a href="{{ route('manager.rooms.edit', $room->id) }}" class="btn btn-sm btn-warning" title="Sửa">
