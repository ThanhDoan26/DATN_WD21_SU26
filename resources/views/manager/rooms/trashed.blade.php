...
@section('title', 'Phòng Đã Xóa - Manager')
                ...
                <tr style="opacity: 0.7;">
                    ...
                    <td>
                        <div class="d-flex gap-2">
                            <!-- Restore Button -->
                            <form action="{{ route('manager.rooms.restore', $room->id) }}" method="POST" style="display:inline;" title="Khôi phục">
                                @csrf
                            ...
                            <!-- Force Delete Button -->
                            <form action="{{ route('manager.rooms.forceDelete', $room->id) }}" method="POST" style="display:inline;" onsubmit="return confirm('⚠️ Cảnh báo: Điều này sẽ XÓA VĩNH VIỄN phòng này. Không thể hoàn tác!\n\nBạn chắc chắn không?');">
                                @csrf
                                @method('DELETE')
