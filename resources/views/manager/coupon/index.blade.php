    ...
    <div class="coupon-table-card">
        ...
        <div class="card-top">
            ...
            <div class="d-flex gap-2">
                <a href="{{ route('manager.coupon.expired') }}" class="btn btn-outline-light btn-sm px-3 rounded-3">
                    <i class="fas fa-history me-1"></i>Mã hết hạn
                </a>
                <a href="{{ route('manager.coupons.create') }}" class="btn btn-warning btn-sm px-3 rounded-3 fw-bold text-dark">
        ...
        <div class="filter-bar">
            <form method="GET" action="{{ route('manager.coupons.index') }}" class="d-flex gap-3 align-items-end flex-wrap">
                <div>
                ...
                <div class="d-flex gap-2">
                    ...
                    <a href="{{ route('manager.coupons.index') }}" class="btn btn-outline-secondary btn-sm px-3 rounded-3">
                        ...
                        @forelse ($coupons as $coupon)
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="{{ route('manager.coupons.edit', $coupon->id) }}"
                                       class="btn btn-warning btn-sm rounded-2 me-1" title="Sửa">
                                        <i class="fas fa-edit"></i>
                                    </a>
                                    <form action="{{ route('manager.coupons.destroy', $coupon->id) }}" method="POST"
