...
<div class="container-fluid p-4" style="max-width: 820px; margin: 0 auto;">
    ...
    <div class="d-flex align-items-center gap-2 mb-4 text-muted small">
        <a href="{{ route('manager.coupons.index') }}" class="text-decoration-none text-muted">
    ...
    <div class="form-card">
        ...
        <div class="p-4">
            <form action="{{ route('manager.coupons.update', $coupon->id) }}" method="POST" id="couponForm">
                @csrf @method('PUT')
                ...
                <div class="d-flex justify-content-end gap-2">
                    <a href="{{ route('manager.coupons.index') }}" class="btn btn-outline-secondary px-4 rounded-3">
...
@section('extra_js')
<script>
@include('manager.coupon._form_js')
</script>
@endsection
