            ...
            <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center gap-2">
                ...
                <div class="text-md-end">
                    <h5 class="fw-bold text-primary mb-1" id="header-cinema">
                        @php
                            $headerCinemaText = $cinemaName ?? 'Rạp của bạn';
        ...
        <div class="col-12 col-xl-6 mb-4">
            <div class="card border-0 shadow-sm h-100">
                ...
                <div class="card-body p-0" id="top-movies-wrapper">
                    @include('manager.dashboard.partials.top_movies')
                </div>
            </div>
        </div>
        ...
        <div class="col-12 col-xl-6 mb-4">
            <div class="card border-0 shadow-sm h-100">
                ...
                <div class="card-body p-0" id="top-combos-wrapper">
                    @include('manager.dashboard.partials.top_combos')
                </div>
            </div>
        </div>
    </div>
...
<div class="card border-0 shadow-sm mt-4">
    <div class="card-body p-4">
        <h5 class="card-title text-primary fw-bold mb-3"><i class="fas fa-info-circle text-primary me-2"></i>Welcome to Manager Panel</h5>
