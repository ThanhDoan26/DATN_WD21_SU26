...
@section('title', 'Chi tiết Suất Chiếu - Admin')
    ...
    <div class="card-body p-4">
        <div class="row align-items-center">
            ...
            <div class="col-md-4 text-md-end mt-3 mt-md-0">
                <a href="{{ route('admin.showtimes.edit', $showtime->id) }}" class="btn btn-primary px-3">
                    <i class="fas fa-edit me-1"></i> Chỉnh Sửa Suất Chiếu
                </a>
                <a href="{{ route('admin.showtimes.index') }}" class="btn btn-outline-secondary px-3 ms-1">
        ...
        <div class="row g-3">
            ...
            <div class="col-md-3">
                <div class="p-3 border rounded-3" style="border-left: 4px solid #0ea5e9 !important;">
                    ...
                    <div class="fs-5 fw-bold text-sky mt-1" style="color: #0284c7;">
...
<style>
    ...
    .cinema-screen { width: 80%; max-width: 600px; margin: 0 auto 40px auto; padding: 12px 0; text-align: center; background: linear-gradient(180deg, rgba(147, 51, 234, 0.12) 0%, rgba(147, 51, 234, 0.02) 100%); border-top: 6px solid #9333ea; border-radius: 8px 8px 120px 120px; font-size: 0.85rem; font-weight: 700; letter-spacing: 8px; color: #9333ea; box-shadow: 0 8px 25px -8px rgba(147, 51, 234, 0.25); text-transform: uppercase; font-family: 'Sora', sans-serif; }
