...
<div class="container-fluid p-4">
    ...
    <div class="card" style="border-radius:18px; overflow:hidden; box-shadow:0 4px 20px rgba(0,0,0,0.06);">
        <div class="card-header d-flex justify-content-between align-items-center"
            ...
            <a href="{{ route('staff.coupons.index') }}" class="btn btn-outline-light btn-sm px-3 rounded-3">
        ...
        <div class="card-body p-4">
            {{-- Filter --}}
            <form method="GET" action="{{ route('staff.coupon.expired') }}" class="d-flex gap-3 mb-4 flex-wrap">
                ...
                <a href="{{ route('staff.coupon.expired') }}" class="btn btn-outline-secondary rounded-3">
